...
router.put('/account-update', checkAuth.verifyToken, authController.updateAccount);
router.post('/change-password', checkAuth.verifyToken, authController.updatePassword);
