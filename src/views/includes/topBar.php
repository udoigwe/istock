...
<div class="navbar-custom">
	<ul class="list-unstyled topnav-menu float-right mb-0">
		...
		<li class="dropdown notification-list">
			<a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
				<img src="../../assets/images/avatar.png" alt="user-avatar" class="rounded-circle user-avatar-small">
	...
	<div class="logo-box">
		<a href="/" class="logo text-center">
			<span class="logo-lg">
				<!-- <img src="../../assets/images/logo1.png" alt="logo" width="30%"> -->
				<img alt="logo" width="30%">
			</span>
			<span class="logo-sm">
				<!-- <img src="../../assets/images/logo1.png" alt="logo" width="80%"> -->
